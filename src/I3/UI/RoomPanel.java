...
public class RoomPanel extends javax.swing.JDialog {
    ...
    }//event_btn_addRoomTypeActionPerformed
    ...
    private void tf_priceKeyTyped(java.awt.event.KeyEvent evt) {//event_tf_priceKeyTyped
    ...
    }//event_tf_priceKeyTyped

    private void btn_addActionPerformed(java.awt.event.ActionEvent evt) {//event_btn_addActionPerformed
    ...
    private void btn_editRoomTypeActionPerformed(java.awt.event.ActionEvent evt) {//event_btn_editRoomTypeActionPerformed
        roomTypeObjectCreation();
    ...
    }//event_btn_editRoomTypeActionPerformed

    private void table_roomTypeMouseClicked(java.awt.event.MouseEvent evt) {//event_table_roomTypeMouseClicked
    ...
    }//event_table_roomTypeMouseClicked

    private void table_roomsMouseClicked(java.awt.event.MouseEvent evt) {//event_table_roomsMouseClicked
        room = new Room(null);
    ...
    }//event_table_roomsMouseClicked

    private void btn_editActionPerformed(java.awt.event.ActionEvent evt) {//event_btn_editActionPerformed
        roomObjectCreation();
    ...
    }//event_btn_editActionPerformed

    private void btn_deleteActionPerformed(java.awt.event.ActionEvent evt) {//event_btn_deleteActionPerformed
    ...
    private void btn_deleteRoomTypeActionPerformed(java.awt.event.ActionEvent evt) {//event_btn_deleteRoomTypeActionPerformed
        //int roomId =Integer.parseInt( tf_roomType.getText() );
        
        JOptionPane.showMessageDialog(null, "no method written yet");
        
    }//:event_btn_deleteRoomTypeActionPerformed

    private void check_wifiActionPerformed(java.awt.event.ActionEvent evt) {//event_check_wifiActionPerformed
        
    }//event_check_wifiActionPerformed
